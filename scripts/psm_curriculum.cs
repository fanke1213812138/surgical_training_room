...
public class psm_curriculum: Agent
{
    public int Defaultlesson;
    ...
    {
        lesson = (int)m_ResetParams.GetWithDefault("lesson", Defaultlesson);
        step=0f;
        //joint——state
        ...
        // ECM.transform.localEulerAngles = new Vector3(Random.Range(10f, 30f), Random.Range(-10f, -40f),90f);
        // ECM.transform.localPosition = new Vector3(Random.Range(-2f, -3f),Random.Range(1f, 1.5f),Random.Range(0f, -0.5f));


        //targ
        targ.transform.localPosition = new Vector3(Random.Range(-1.398f, -1.381f),1.2513f,Random.Range(0.14f, 0.2f));
    ...
    { step= step+1f;
        ...
        urdfJoint[0].UpdateJointState(j1_a*0.003f);
        urdfJoint[1].UpdateJointState(j2_a*0.003f);
        urdfJoint[2].UpdateJointState(j3_a*0.0003f);
        urdfJoint[3].UpdateJointState(j4_a*0.003f);
        urdfJoint[4].UpdateJointState(j5_a*0.003f);
        urdfJoint[5].UpdateJointState(j6_a*0.003f); 
    ...
    // Update is called once per frame
        ...
        // reward = 1f-2f*distanceToTarget/maxdis;  
