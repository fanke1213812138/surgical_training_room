...
public class PointCloudRenderer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        meshRenderer = elp.GetComponent<MeshRenderer>();
        mf = elp.GetComponent<MeshFilter>();
    ...
    void UpdateMesh()
    {
        ...
        for (int i = 0; i < positions.Length; i++)
            {   
                //print("zubiao"+(positions[i]/1000f));
                positions[i]= positions[i]/1000f;
