...
public class ImageSynthesis : MonoBehaviour {
	...
	void Start()
	{
		...
		capturePasses[2].camera = seg_camera.GetComponent<Camera>();
		capturePasses[2].camera.rect = new Rect(0.6f,0f, 0.4f, 0.5f);
		for (int q = 3; q < capturePasses.Length; q++)
